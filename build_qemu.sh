...
if [ "$STATIC" = "1" ]; then
  ...
  CFLAGS="-O3 -ggdb" LDFLAGS="-ldl" ./configure --disable-bsd-user --disable-guest-agent --disable-strip --disable-werror \
  ...
  CFLAGS="-O3 -ggdb" LDFLAGS="-ldl" ./configure --disable-system \
